...
searchBar.addEventListener("keyup", () => {
  ...
  document
    .querySelectorAll(
      ".kunafa-content, .kunafa-container2, .bint-content, .bint-container2, .addons-content, .addons-container2"
    )
    .forEach((section) => {
  ...
  document
    .querySelectorAll("#kunafa-container, #bint-container, #addons-container")
    .forEach((category) => {
